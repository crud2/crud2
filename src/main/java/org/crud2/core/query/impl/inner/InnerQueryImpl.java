...
public class InnerQueryImpl extends AbstractQueryImpl {
    ...
    public DataTable queryDataTable() {
        ...
        return sqlContextFactory.getSQLContext(dataSource).queryDataTable(dataCommand);
    }

    @Override
    public List<Map<String, Object>> queryListMap() {
        buildQueryCommand();
        return sqlContextFactory.getSQLContext(dataSource).queryForMapList(dataCommand);
    }
    ...
    public Map<String, Object> getMap() {
        buildQueryCommand();
        return sqlContextFactory.getSQLContext(dataSource).queryForMap(dataCommand);
    }
    ...
    public PagerResult<List<Map<String, Object>>> queryListMapPager() {
        ...
        long total = sqlContextFactory.getSQLContext(dataSource).queryForLong(countCommand);
        List<Map<String, Object>> data = sqlContextFactory.getSQLContext(dataSource).queryForMapList(dataCommand);
    ...
    public PagerResult<DataTable> queryDataTablePager() {
        buildQueryCommand(true);
        long total = sqlContextFactory.getSQLContext(dataSource).queryForLong(countCommand);
        DataTable data = sqlContextFactory.getSQLContext(dataSource).queryDataTable(dataCommand);
